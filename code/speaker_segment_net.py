...
BATCH_PER_EPOCH = 1
NUM_EPOCH = 1000
TRAIN_GENERATOR = shakespeare_soft_train_gen
TEST_GENERATOR = shakespeare_soft_test_gen

def inf_generator(generator):
    """
    Creates an infinite generator that yields what
    the input generators yields. When the input generator
    has finished, this will reset to the beginning of the input.
    """
    while True:
        try:
...
def many_to_one_model():
    """
    Creates a many-to-one network. Trains the network on the data
    generated by the generators specified by TRAIN_GENERATOR and 
    TEST_GENERATOR. 
    """
